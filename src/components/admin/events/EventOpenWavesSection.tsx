...
import { useAdminEventWaves, updateAdminEventWave, type AdminEventWave } from '@/app/api/admin/events/eventsQueries'
              ...
              {(data ?? []).map((wave) => {
                ...
                return (
                  <TableRow key={wave.wave_index}>
                    ...
                    <TableCell>{formatWaveStartTime(wave.start_time) ?? '—'}</TableCell>
                    <TableCell>
                      <Input

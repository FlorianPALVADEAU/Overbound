...
const VolunteerBanner = () => {
    return (
        <div className='py-[15px] lg:py-[30px] relative overflow-hidden bg-gray-300 flex flex-row text-black'>
...
const VolunteersAppeal = () => {
  return (
    <section className='text-white bg-gradient-to-br from-gray-900 via-gray-800 to-gray-900 w-full min-h-[screen] flex flex-col justify-between items-center relative overflow-hidden'>
        ...
        <div className='relative z-10 w-full h-auto flex flex-col justify-start items-start gap-8 sm:gap-10 md:gap-12 py-8 sm:py-12 md:py-16 lg:py-20 px-4 sm:px-6 md:px-8 lg:px-16 xl:px-32'>
            ...
            <div className='w-full h-auto flex flex-col lg:flex-row justify-between items-start gap-8 md:gap-10 lg:gap-12 xl:gap-16'>
                ...
                <div className='w-full lg:w-3/5 h-auto flex flex-col justify-start items-start gap-4 sm:gap-5 md:gap-6'>
                    ...
                    {/* Card des avantages */}
                    <Card className='w-full mt-4 sm:mt-6 p-4 sm:p-5 md:p-6 border-2 border-gray-600 bg-gradient-to-br from-gray-700/50 to-gray-800/50 backdrop-blur-sm hover:shadow-xl transition-all duration-300'>
                        <div className='space-y-3 sm:space-y-4'>
                            ...
                            <ul className='list-none space-y-2 sm:space-y-3 text-sm sm:text-base'>
                                ...
                                <li className='flex items-start gap-3'>
                                    <span className='text-red-400 text-lg'>💰</span>
                                    <span className='text-gray-200'>Une réduction de <strong className='text-red-400'>-75%</strong> sur ta prochaine course Overbound</span>
                                </li>
                            </ul>
                        </div>
                    </Card>
                ...
                <div className='w-full lg:w-2/5 h-auto flex flex-col justify-start lg:justify-center items-center gap-6 sm:gap-8 md:gap-10 lg:gap-12 lg:px-6 xl:px-12'>
                    ...
                    <div className='relative w-full max-w-sm lg:max-w-none group'>
                        <div className='absolute -inset-1 bg-gradient-to-r from-red-600 to-orange-600 rounded-xl blur opacity-25 group-hover:opacity-40 transition duration-300'></div>
                    ...
                    {/* CTA Button */}
                    <Button 
                        className='w-full max-w-sm lg:max-w-none h-12 sm:h-14 md:h-16 text-base sm:text-lg md:text-xl font-semibold bg-gradient-to-r from-red-600 to-red-700 hover:from-red-700 hover:to-red-800 transform hover:scale-105 transition-all duration-300 shadow-lg hover:shadow-xl'
                        variant='destructive'
                    >

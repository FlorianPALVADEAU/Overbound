...
export const FORMAT_LEVELS: Record<
  FormatLevelId,
  { id: FormatLevelId; name: string; path: string; badgeClass: string; accentClass: string }
> = {
  low: {
    id: 'low',
    name: 'Primal',
    path: '/events/formats/primal',
  ...
  hard: {
    id: 'hard',
    name: 'Ultra Hardcore',
    path: '/events/formats/ultra-hardcore',

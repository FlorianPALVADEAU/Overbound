...
export type EventStatus = 'draft' | 'on_sale' | 'sold_out' | 'cancelled' | 'completed';
...
export type ObstacleType = 'force' | 'agilité' | 'technique' | 'endurance';
export type RaceType = 'trail' | 'obstacle' | 'urbain' | 'nature';
export type TargetPublic = 'débutant' | 'intermédiaire' | 'expert' | 'famille' | 'elite';
export type Currency = 'eur' | 'usd' | 'gbp';
export type DocumentType = 'sports_license' | 'medical_certificate' | 'insurance' | 'identity';
...
export type UpdateRegistration = Partial<Omit<Registration, 'id' | 'created_at'>> & { id: UUID };
